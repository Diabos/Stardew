...
public class KeyboardDispatcher
{
	...
	public void Poll()
	{
		...
		bool flag = ((SdlClipboard.Platform != ClipboardPlatformType.OSX) ? (keyboardState.IsKeyDown(Keys.LeftControl) || keyboardState.IsKeyDown(Keys.RightControl)) : (keyboardState.IsKeyDown(Keys.LeftWindows) || keyboardState.IsKeyDown(Keys.RightWindows)));
		if (keyboardState.IsKeyDown(Keys.V) && !_oldKeyboardState.IsKeyDown(Keys.V) && flag)
		{
			string output = null;
