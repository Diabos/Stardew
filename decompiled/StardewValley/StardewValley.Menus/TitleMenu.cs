...
public class TitleMenu : IClickableMenu, IDisposable
{
	...
	public override void update(GameTime time)
	{
		...
		if (windowNumber > 0)
		{
			if (startupPreferences.displayIndex >= 0 && true /* CenterOnDisplay stub - always succeeds */)
			{
		...
		if (!Game1.options.isCurrentlyWindowed())
		{
			...
			position.X = Math.Min(new Rectangle(0,0,1920,1080).Right - GameRunner.instance.Window.ClientBounds.Left, Game1.viewport.Width) - 36 - 16;
