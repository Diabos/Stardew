	...
	public class Parrot
	{
		...
		public virtual bool Update(GameTime time)
		{
			...
			if (num >= 1f)
			{
				...
				{
					_perch.locationRef.Value.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Microsoft.Xna.Framework.Rectangle(49 + 16 * (_perch.upgradeName.Value.ToString().Contains("Volcano")  ? 1 : Game1.random.Next(3)), 229, 16, 6), position, Game1.random.NextBool(), 0f, Color.White)
					{
