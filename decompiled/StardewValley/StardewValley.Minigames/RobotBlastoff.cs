...
public class RobotBlastoff : IMinigame
{
	...
	public bool tick(GameTime time)
	{
		...
		float num = 1.35f - 0.85f * (5f / Math.Max(5f, robotPosition.Y / 20f));
		backgroundPosition += (int)(0.25f * (float)time.ElapsedGameTime.Milliseconds * num) / 2;
	...
	public void changeScreenSize()
	{
		...
		backgroundPosition = 2560 - (int)((float)Game1.game1.localMultiplayerWindow.Height * num);
		robotPosition = new Vector2(Game1.game1.localMultiplayerWindow.Width / 2, Game1.game1.localMultiplayerWindow.Height) * num;
	}
